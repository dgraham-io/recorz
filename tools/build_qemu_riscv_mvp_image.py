...
OBJECT_KIND_DEFINITIONS = [
    ...
    ("RECORZ_MVP_OBJECT_DISPLAY", SEED_OBJECT_DISPLAY),
    ("RECORZ_MVP_OBJECT_FORM", SEED_OBJECT_FORM),
    ("RECORZ_MVP_OBJECT_BITMAP", SEED_OBJECT_BITMAP),
    ("RECORZ_MVP_OBJECT_BITBLT", SEED_OBJECT_BITBLT),
    ("RECORZ_MVP_OBJECT_GLYPHS", SEED_OBJECT_GLYPHS),
    ("RECORZ_MVP_OBJECT_FORM_FACTORY", SEED_OBJECT_FORM_FACTORY),
    ("RECORZ_MVP_OBJECT_BITMAP_FACTORY", SEED_OBJECT_BITMAP_FACTORY),
    ("RECORZ_MVP_OBJECT_TEXT_LAYOUT", SEED_OBJECT_TEXT_LAYOUT),
    ("RECORZ_MVP_OBJECT_TEXT_STYLE", SEED_OBJECT_TEXT_STYLE),
    ("RECORZ_MVP_OBJECT_TEXT_METRICS", SEED_OBJECT_TEXT_METRICS),
    ("RECORZ_MVP_OBJECT_TEXT_BEHAVIOR", SEED_OBJECT_TEXT_BEHAVIOR),
    ("RECORZ_MVP_OBJECT_CLASS", SEED_OBJECT_CLASS),
    ("RECORZ_MVP_OBJECT_METHOD_DESCRIPTOR", SEED_OBJECT_METHOD_DESCRIPTOR),
    ("RECORZ_MVP_OBJECT_METHOD_ENTRY", SEED_OBJECT_METHOD_ENTRY),
    ("RECORZ_MVP_OBJECT_SELECTOR", SEED_OBJECT_SELECTOR),
    ("RECORZ_MVP_OBJECT_ACCESSOR_METHOD", SEED_OBJECT_ACCESSOR_METHOD),
    ("RECORZ_MVP_OBJECT_FIELD_SEND_METHOD", SEED_OBJECT_FIELD_SEND_METHOD),
    ("RECORZ_MVP_OBJECT_ROOT_SEND_METHOD", SEED_OBJECT_ROOT_SEND_METHOD),
    ("RECORZ_MVP_OBJECT_ROOT_VALUE_METHOD", SEED_OBJECT_ROOT_VALUE_METHOD),
    ("RECORZ_MVP_OBJECT_INTERPRETED_METHOD", SEED_OBJECT_INTERPRETED_METHOD),
    ("RECORZ_MVP_OBJECT_COMPILED_METHOD", SEED_OBJECT_COMPILED_METHOD),
]
SEED_FIELD_KIND_DEFINITIONS = list(SEED_FIELD_VALUES.items())
SEED_ROOT_DEFINITIONS = [
    ("RECORZ_MVP_SEED_ROOT_DEFAULT_FORM", SEED_ROOT_DEFAULT_FORM),
    ("RECORZ_MVP_SEED_ROOT_FRAMEBUFFER_BITMAP", SEED_ROOT_FRAMEBUFFER_BITMAP),
    ("RECORZ_MVP_SEED_ROOT_TRANSCRIPT_BEHAVIOR", SEED_ROOT_TRANSCRIPT_BEHAVIOR),
    ("RECORZ_MVP_SEED_ROOT_TRANSCRIPT_LAYOUT", SEED_ROOT_TRANSCRIPT_LAYOUT),
    ("RECORZ_MVP_SEED_ROOT_TRANSCRIPT_STYLE", SEED_ROOT_TRANSCRIPT_STYLE),
    ("RECORZ_MVP_SEED_ROOT_TRANSCRIPT_METRICS", SEED_ROOT_TRANSCRIPT_METRICS),
]
