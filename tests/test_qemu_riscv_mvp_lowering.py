...
class QemuRiscvMvpLoweringTests(unittest.TestCase):
    ...
    def test_builds_dynamic_seed_sections_from_fixed_boot_graph(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                (mvp.SEED_FIELD_OBJECT_INDEX, 276),
                (mvp.SEED_FIELD_SMALL_INTEGER, 2),
            ],
        )
        self.assertIsNone(
    ...
    def test_declares_method_seed_orders_and_materializes_method_seed_objects(self) -> None:
        ...
        self.assertEqual(compiled_method_indices["RECORZ_MVP_METHOD_ENTRY_TRANSCRIPT_SHOW"], 215)
        self.assertEqual(compiled_method_indices["RECORZ_MVP_METHOD_ENTRY_CLASS_INSTANCE_KIND"], 226)
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            [
                ...
                (mvp.SEED_FIELD_OBJECT_INDEX, 215),
            ],
        )
        ...
        self.assertEqual(method_start_by_kind[mvp.SEED_OBJECT_CLASS], 272)
        ...
        self.assertEqual(
            ...
            [
                ...
                (mvp.SEED_FIELD_SMALL_INTEGER, 0),
                (mvp.SEED_FIELD_SMALL_INTEGER, mvp.SEED_OBJECT_CLASS),
                (mvp.SEED_FIELD_OBJECT_INDEX, 248),
            ],
        )
    ...
    def test_renders_generated_runtime_bindings_header(self) -> None:
        ...
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_KERNEL_INSTALLER_REMEMBER_OBJECT_NAMED = 30,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_KERNEL_INSTALLER_OBJECT_NAMED = 31,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_KERNEL_INSTALLER_SAVE_SNAPSHOT = 32,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_KERNEL_INSTALLER_CONFIGURE_STARTUP_SELECTOR_NAMED = 33,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_KERNEL_INSTALLER_CLEAR_STARTUP = 34,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_FILE_IN = 35,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_CONTENTS = 36,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_SET_CONTENTS = 37,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_EVALUATE = 38,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_EVALUATE_CURRENT = 39,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_FILE_IN_CURRENT = 40,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_BROWSE_CLASSES = 41,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_BROWSE_METHODS_FOR_CLASS_NAMED = 42,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_BROWSE_OBJECT_NAMED = 43,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_BROWSE_CLASS_NAMED = 44,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_BROWSE_METHOD_OF_CLASS_NAMED = 45,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_BROWSE_CLASS_METHODS_FOR_CLASS_NAMED = 46,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_BROWSE_CLASS_METHOD_OF_CLASS_NAMED = 47,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_RERUN = 48,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_WORKSPACE_REOPEN = 49,", header)
        self.assertIn("RECORZ_MVP_METHOD_ENTRY_COUNT = 50,", header)
        ...
        self.assertIn("RECORZ_MVP_PRIMITIVE_KERNEL_INSTALLER_REMEMBER_OBJECT_NAMED = 18,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_KERNEL_INSTALLER_OBJECT_NAMED = 19,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_KERNEL_INSTALLER_SAVE_SNAPSHOT = 20,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_KERNEL_INSTALLER_CONFIGURE_STARTUP_SELECTOR_NAMED = 21,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_KERNEL_INSTALLER_CLEAR_STARTUP = 22,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_FILE_IN = 23,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_CONTENTS = 24,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_SET_CONTENTS = 25,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_EVALUATE = 26,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_EVALUATE_CURRENT = 27,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_FILE_IN_CURRENT = 28,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_BROWSE_CLASSES = 29,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_BROWSE_METHODS_FOR_CLASS_NAMED = 30,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_BROWSE_OBJECT_NAMED = 31,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_BROWSE_CLASS_NAMED = 32,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_BROWSE_METHOD_OF_CLASS_NAMED = 33,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_BROWSE_CLASS_METHODS_FOR_CLASS_NAMED = 34,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_BROWSE_CLASS_METHOD_OF_CLASS_NAMED = 35,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_RERUN = 36,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_WORKSPACE_REOPEN = 37,", header)
        self.assertIn("RECORZ_MVP_PRIMITIVE_COUNT = 38,", header)
    ...
    def test_builds_seed_manifest_with_expected_header(self) -> None:
        ...
        self.assertEqual(object_count, 325)
        ...
        self.assertEqual(
            ...
            [
                ...
                (
                    ...
                    227 + (mvp.METHOD_ENTRY_VALUES["RECORZ_MVP_METHOD_ENTRY_CLASS_INSTANCE_KIND"] - 1),
                ),
            ],
        )
