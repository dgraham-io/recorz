...
class QemuRiscvMvpLoweringTests(unittest.TestCase):
    ...
    def test_derives_seed_object_and_root_maps_from_specs(self) -> None:
        ...
        self.assertEqual(
            ...
            ("WorkspaceTool", "RECORZ_MVP_OBJECT_WORKSPACE_TOOL"),
        )
        self.assertEqual(
        ...
        self.assertEqual(mvp.OBJECT_KIND_DEFINITIONS[-1], ("RECORZ_MVP_OBJECT_WORKSPACE_TOOL", 36))
    ...
    def test_declares_seed_layout_sections_and_derives_layout(self) -> None:
        ...
        self.assertEqual(layout["class_descriptors"], mvp.SeedLayoutSection(140, 36))
        self.assertEqual(
            layout["selectors"],
    ...
    def test_builds_dynamic_seed_sections_from_fixed_boot_graph(self) -> None:
        ...
        self.assertEqual(dynamic_sections.seed_layout["class_descriptors"], mvp.SeedLayoutSection(152, 36))
