    ...
    def test_derives_global_maps_from_boot_object_exports_and_selector_maps_from_source(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                ("RECORZ_MVP_SELECTOR_DRAW_HEADER_ON_FORM_BOUNDS", 249),
                ("RECORZ_MVP_SELECTOR_DRAW_EDITOR_ON_FORM_BOUNDS", 250),
                ("RECORZ_MVP_SELECTOR_DRAW_STATUS_FEEDBACK_ON_FORM_BOUNDS", 251),
                ("RECORZ_MVP_SELECTOR_DRAW_COMMANDS_ON_FORM_BOUNDS", 252),
            ],
        )
