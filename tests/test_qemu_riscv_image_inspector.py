...
class QemuRiscvImageInspectorTests(unittest.TestCase):
    ...
    def test_inspects_boot_image_summary(self) -> None:
        ...
        self.assertEqual(summary["seed"]["object_count"], 289)
        self.assertEqual(summary["seed"]["class_descriptor_count"], 20)
        self.assertEqual(summary["seed"]["class_link_count"], 289)
        self.assertEqual(summary["seed"]["method_descriptor_count"], 37)
        self.assertEqual(summary["seed"]["selector_object_count"], 41)
        ...
        self.assertEqual(summary["seed"]["method_entry_object_count"], 37)
        self.assertEqual(summary["seed"]["declared_method_count"], 37)
        self.assertEqual(summary["seed"]["method_entry_count"], 37)
