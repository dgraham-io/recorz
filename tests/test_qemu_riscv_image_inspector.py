...
class QemuRiscvImageInspectorTests(unittest.TestCase):
    ...
    def test_inspects_boot_image_summary(self) -> None:
        ...
        self.assertEqual(summary["seed"]["global_binding_count"], 13)
        ...
        self.assertEqual(summary["seed"]["globals"]["WorkspaceCursor"], 149)
        self.assertEqual(summary["seed"]["globals"]["WorkspaceSelection"], 150)
        self.assertEqual(summary["seed"]["roots"]["default_form"], 11)
        self.assertEqual(summary["seed"]["roots"]["transcript_behavior"], 147)
        self.assertEqual(summary["seed"]["roots"]["transcript_layout"], 8)
        self.assertEqual(summary["seed"]["roots"]["transcript_style"], 9)
        self.assertEqual(summary["seed"]["roots"]["transcript_metrics"], 146)
        self.assertEqual(summary["seed"]["roots"]["transcript_font"], 148)
