...
class QemuRiscvImageInspectorTests(unittest.TestCase):
    ...
    def test_inspects_boot_image_summary(self) -> None:
        ...
        self.assertEqual(summary["seed"]["object_count"], 391)
        self.assertEqual(summary["seed"]["class_descriptor_count"], 24)
        self.assertEqual(summary["seed"]["class_link_count"], 391)
        self.assertEqual(summary["seed"]["method_descriptor_count"], 65)
        self.assertEqual(summary["seed"]["selector_object_count"], 77)
        ...
        self.assertEqual(summary["seed"]["compiled_method_object_count"], 16)
        self.assertEqual(summary["seed"]["method_entry_object_count"], 65)
        self.assertEqual(summary["seed"]["declared_method_count"], 65)
        self.assertEqual(summary["seed"]["method_entry_count"], 65)
        self.assertEqual(summary["seed"]["global_binding_count"], 10)
