...
class QemuRiscvImageInspectorTests(unittest.TestCase):
    ...
    def test_inspects_boot_image_summary(self) -> None:
        ...
        self.assertEqual(summary["seed"]["object_count"], 263)
        self.assertEqual(summary["seed"]["class_descriptor_count"], 19)
        self.assertEqual(summary["seed"]["class_link_count"], 263)
        self.assertEqual(summary["seed"]["method_descriptor_count"], 29)
        self.assertEqual(summary["seed"]["selector_object_count"], 33)
