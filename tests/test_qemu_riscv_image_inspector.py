...
class QemuRiscvImageInspectorTests(unittest.TestCase):
    ...
    def test_inspects_boot_image_summary(self) -> None:
        ...
        self.assertEqual(summary["seed"]["object_count"], 388)
        self.assertEqual(summary["seed"]["class_descriptor_count"], 24)
        self.assertEqual(summary["seed"]["class_link_count"], 388)
        self.assertEqual(summary["seed"]["method_descriptor_count"], 64)
        self.assertEqual(summary["seed"]["selector_object_count"], 76)
