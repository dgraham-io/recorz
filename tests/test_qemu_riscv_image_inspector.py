...
class QemuRiscvImageInspectorTests(unittest.TestCase):
    ...
    def test_inspects_boot_image_summary(self) -> None:
        ...
        self.assertEqual(summary["seed"]["object_count"], 238)
        self.assertEqual(summary["seed"]["class_descriptor_count"], 18)
        self.assertEqual(summary["seed"]["class_link_count"], 238)
        self.assertEqual(summary["seed"]["method_descriptor_count"], 24)
        self.assertEqual(summary["seed"]["selector_object_count"], 19)
        ...
        self.assertEqual(summary["seed"]["method_entry_object_count"], 24)
        self.assertEqual(summary["seed"]["declared_method_count"], 24)
        self.assertEqual(summary["seed"]["method_entry_count"], 24)
        self.assertEqual(summary["seed"]["global_binding_count"], 7)
        ...
        self.assertEqual(summary["seed"]["roots"]["transcript_behavior"], 140)
        self.assertEqual(summary["seed"]["roots"]["transcript_layout"], 6)
        self.assertEqual(summary["seed"]["roots"]["transcript_style"], 7)
        self.assertEqual(summary["seed"]["roots"]["transcript_metrics"], 139)
