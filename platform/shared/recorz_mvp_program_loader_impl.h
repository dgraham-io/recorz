#ifndef RECORZ_SHARED_MVP_PROGRAM_LOADER_IMPL_H
#define RECORZ_SHARED_MVP_PROGRAM_LOADER_IMPL_H
...
#define RECORZ_MVP_PROGRAM_MAX_SELECTOR_ID RECORZ_MVP_SELECTOR_PACKAGE_SOURCE_TO_OPEN_FOR_PRIOR_TARGET
