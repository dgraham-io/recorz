...
enum recorz_mvp_method_entry {
    RECORZ_MVP_METHOD_ENTRY_TRANSCRIPT_SHOW = 1,
    RECORZ_MVP_METHOD_ENTRY_TRANSCRIPT_CR = 2,
    RECORZ_MVP_METHOD_ENTRY_DISPLAY_DEFAULT_FORM = 3,
    RECORZ_MVP_METHOD_ENTRY_DISPLAY_CLEAR = 4,
    RECORZ_MVP_METHOD_ENTRY_DISPLAY_WRITE_STRING = 5,
    RECORZ_MVP_METHOD_ENTRY_DISPLAY_NEWLINE = 6,
    RECORZ_MVP_METHOD_ENTRY_BITBLT_FILL_FORM_COLOR = 7,
    RECORZ_MVP_METHOD_ENTRY_BITBLT_COPY_BITMAP_TO_FORM_X_Y_SCALE = 8,
    RECORZ_MVP_METHOD_ENTRY_BITBLT_COPY_BITMAP_TO_FORM_X_Y_SCALE_COLOR = 9,
    RECORZ_MVP_METHOD_ENTRY_BITBLT_COPY_BITMAP_SOURCE_X_SOURCE_Y_WIDTH_HEIGHT_TO_FORM_X_Y_SCALE_COLOR = 10,
    RECORZ_MVP_METHOD_ENTRY_GLYPHS_AT = 11,
    RECORZ_MVP_METHOD_ENTRY_FORM_FACTORY_FROM_BITS = 12,
    RECORZ_MVP_METHOD_ENTRY_BITMAP_FACTORY_MONO_WIDTH_HEIGHT = 13,
    RECORZ_MVP_METHOD_ENTRY_BITMAP_WIDTH = 14,
    RECORZ_MVP_METHOD_ENTRY_BITMAP_HEIGHT = 15,
    RECORZ_MVP_METHOD_ENTRY_FORM_CLEAR = 16,
    RECORZ_MVP_METHOD_ENTRY_FORM_WRITE_STRING = 17,
    RECORZ_MVP_METHOD_ENTRY_FORM_NEWLINE = 18,
    RECORZ_MVP_METHOD_ENTRY_FORM_BITS = 19,
    RECORZ_MVP_METHOD_ENTRY_FORM_WIDTH = 20,
    RECORZ_MVP_METHOD_ENTRY_FORM_HEIGHT = 21,
    RECORZ_MVP_METHOD_ENTRY_CLASS_INSTANCE_KIND = 22,
    RECORZ_MVP_METHOD_ENTRY_COUNT = 23,
};

enum recorz_mvp_primitive_binding {
    RECORZ_MVP_PRIMITIVE_BITBLT_FILL_FORM_COLOR = 1,
    RECORZ_MVP_PRIMITIVE_BITBLT_COPY_BITMAP_TO_FORM_X_Y_SCALE = 2,
    RECORZ_MVP_PRIMITIVE_BITBLT_COPY_BITMAP_TO_FORM_X_Y_SCALE_COLOR = 3,
    RECORZ_MVP_PRIMITIVE_BITBLT_COPY_BITMAP_SOURCE_X_SOURCE_Y_WIDTH_HEIGHT_TO_FORM_X_Y_SCALE_COLOR = 4,
    RECORZ_MVP_PRIMITIVE_GLYPHS_AT = 5,
    RECORZ_MVP_PRIMITIVE_FORM_FACTORY_FROM_BITS = 6,
    RECORZ_MVP_PRIMITIVE_BITMAP_FACTORY_MONO_WIDTH_HEIGHT = 7,
    RECORZ_MVP_PRIMITIVE_FORM_CLEAR = 8,
    RECORZ_MVP_PRIMITIVE_FORM_WRITE_STRING = 9,
    RECORZ_MVP_PRIMITIVE_FORM_NEWLINE = 10,
    RECORZ_MVP_PRIMITIVE_COUNT = 11,
};
