...
#define RECORZ_MVP_PROGRAM_MAGIC_0 'R'
#define RECORZ_MVP_PROGRAM_MAGIC_1 'C'
#define RECORZ_MVP_PROGRAM_MAGIC_2 'Z'
#define RECORZ_MVP_PROGRAM_MAGIC_3 'P'
#define RECORZ_MVP_PROGRAM_VERSION 1U
#define RECORZ_MVP_PROGRAM_HEADER_SIZE 12U
#define RECORZ_MVP_PROGRAM_INSTRUCTION_SIZE 4U
#define RECORZ_MVP_PROGRAM_LITERAL_HEADER_SIZE 8U
